...
// 列表控件绘制
void KeyValue::DrawListInput(std::string& listValue, const ListType& listType) {
...
// 列表编辑窗口实现
void KeyValue::OpenListEditor(std::string& listValue, const ListType& listType) {
...
// 元素级编辑器
bool KeyValue::DrawElementEditor(std::string& value, const TypeInfo& type) {
